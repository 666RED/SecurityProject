  ...
  <div class="bg">
    <div class="form-container">
      ...
      <form action="" method="post" onsubmit="return validateForm()">
        ...
        <input type="text" id="student_matric_number" name="student_matric_number"
          placeholder="Enter your matric number" required maxlength="8">
        ...
        <input type="email" id="student_student_email" name="student_student_email"
          placeholder="Enter your student email" required maxlength="30">
