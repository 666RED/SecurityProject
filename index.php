...
<div class="bg">
    <div class="form-container">
        ...
        <a href="#" onclick="document.getElementById('idReset').style.display='block'" class="w3-bar-item w3-button">Forgot Password?</a>
    </div>
</div>
    ...
    <div class="w3-modal-content w3-round-large w3-card-4 w3-animate-zoom" style="max-width:500px">
        ...
        <div class="w3-container w3-padding w3-margin">
            ...
            <form action="" method="post">
                ...
                <button type="submit" class="w3-button w3-block w3-padding-large w3-blue w3-wide w3-margin-bottom w3-round">Reset Password</button>
            </form>
            <div class="w3-center">
                Already registered? <a href="#" onclick="document.getElementById('idReset').style.display='none';" class="w3-text-blue">LOGIN HERE</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="w3-modal-content w3-round-large w3-card-4 w3-animate-zoom" style="max-width:500px">
        ...
        <div class="w3-container w3-padding">
            <form action="" method="post">
                ...
                <a onclick="document.getElementById('idSuccessReset').style.display='none'; document.getElementById('idReset').style.display='none';" class="w3-button w3-block w3-padding-large w3-green w3-wide w3-margin-bottom w3-round">SIGN IN</a>
            </form>
        </div>
    </div>
</div>
