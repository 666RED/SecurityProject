...
<body>
  ...
  <div class="form-container">
    ...
    <form action="" method="post">
      ...
      <input type="text" id="student_matric_number" name="student_matric_number" class="w3-input" maxlength="8"
        value="<?php echo $student['student_matric_number']; ?>">

      <label for="student_name">Name</label>
      <input type="text" id="student_name" name="student_name" class="w3-input" maxlength="50"
      ...
      <input type="date" id="student_DOB" name="student_DOB" class="w3-input"
        value="<?php echo $student['student_DOB']; ?>">
      ...
      <input type="email" id="student_student_email" name="student_student_email" class="w3-input" maxlength="30"
        value="<?php echo $student['student_student_email']; ?>">

      <label for="student_phone_number">Phone Number</label>
      <input type="text" id="student_phone_number" name="student_phone_number" class="w3-input" maxlength="11"
        pattern="\d{11}" placeholder="Without ( - )" value="<?php echo $student['student_phone_number']; ?>">

      <label for="student_IC">IC</label>
      <input type="text" id="student_IC" name="student_IC" class="w3-input" maxlength="12" pattern="\d{12}"
        placeholder="Without ( - )" value="<?php echo $student['student_IC']; ?>">

      <label for="student_nationality">Nationality</label>
      <input type="text" id="student_nationality" name="student_nationality" class="w3-input"
        value="<?php echo $student['student_nationality']; ?>">

      <label for="student_race">Race</label>
      <input type="text" id="student_race" name="student_race" class="w3-input"
        value="<?php echo $student['student_race']; ?>">

      <label for="student_personal_email">Personal Email</label>
      <input type="email" id="student_personal_email" name="student_personal_email" class="w3-input" placeholder="Email"
        value="<?php echo $student['student_personal_email']; ?>">

      <label for="student_muet_band">MUET Band</label>
      <input type="text" id="student_muet_band" name="student_muet_band" class="w3-input" maxlength="1"
        placeholder="1 - 6" value="<?php echo $student['student_muet_band']; ?>">

      <label for="student_pre_university_result">Pre-University Result</label>
      <input type="text" id="student_pre_university_result" name="student_pre_university_result" class="w3-input"
        maxlength="4" pattern="\d(\.\d{1,2})?" placeholder="0.00"
        value="<?php echo $student['student_pre_university_result']; ?>">
