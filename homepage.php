...
<head>
  ...
  .news-container {
    ...
    margin: auto;
    margin-top: 100px;
    /* Adjust margin to account for fixed top menu */
  }
...
<body>
  ...
  <div class="news-container">
    ...
    <div class="w3-panel w3-border w3-light-grey">
      ...
      <ul class="w3-ul">
        <li><strong>23/05/2024</strong> The semester starts on 1st September. Make sure to register your courses by 25th
          August.</li>
        <li><strong>17/05/2024</strong> New library hours: Mon-Fri, 8 AM to 8 PM.</li>
        <li><strong>15/05/2024</strong> Student orientation will be held online this year due to ongoing health
          concerns.</li>
        ...
        <li><strong>19/03/2024</strong> Submit your research papers by 30th September for the annual student conference.
        </li>
